...
metrics = {
    ...
    "metadata_discovery_completions": 0,
    "metadata_extraction_jobs_queued": 0,
    "metadata_extraction_jobs_coalesced": 0,
    "metadata_extraction_jobs_dropped": 0,
    "metadata_extraction_jobs_stale": 0,
    "metadata_extraction_jobs_completed": 0,
...
def prometheus_text() -> str:
    ...
    lines = [
        ...
        f"proxy_metadata_discovery_completions_total {metrics['metadata_discovery_completions']}",
        f"proxy_metadata_extraction_jobs_queued_total {metrics['metadata_extraction_jobs_queued']}",
        f"proxy_metadata_extraction_jobs_coalesced_total {metrics['metadata_extraction_jobs_coalesced']}",
        f"proxy_metadata_extraction_jobs_dropped_total {metrics['metadata_extraction_jobs_dropped']}",
        f"proxy_metadata_extraction_jobs_stale_total {metrics['metadata_extraction_jobs_stale']}",
        f"proxy_metadata_extraction_jobs_completed_total {metrics['metadata_extraction_jobs_completed']}",
